...
dependencies {
	    compile 'com.github.raxden:AndroidMVP:1.0.0@aar'
}
```
...
For a **detailed documentation**, please have a look at the [**Wiki**](https://github.com/raxden/AndroidMVP/wiki) or the [**Javadocs**](https://jitpack.io/com/github/raxden/AndroidMVP/1.0.0/javadoc/).
